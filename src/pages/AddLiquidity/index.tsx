...
import { Currency, currencyEquals, ETHER, TokenAmount, WPRIVIX } from 'psc-sdk'
import { Button, CardBody, AddIcon, Text as UIKitText } from 'psc-ui-kit'
...
export default function AddLiquidity({
  ...
  const oneCurrencyIsWETH = Boolean(
    chainId &&
      ((currencyA && currencyEquals(currencyA, WPRIVIX[chainId])) ||
        (currencyB && currencyEquals(currencyB, WPRIVIX[chainId])))
  )
  ...
  const handleCurrencyBSelect = useCallback(
    (currB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        history.push(`/add/${currencyIdA || 'PRIVIX'}/${newCurrencyIdB}`)
      }
    },
